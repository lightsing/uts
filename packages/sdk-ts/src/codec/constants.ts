...
export const EAS_ATTEST_TAG = new Uint8Array([
  0x8b, 0xf4, 0x6b, 0xf4, 0xcf, 0xd6, 0x74, 0xfa,
])
export const EAS_TIMESTAMPED_TAG = new Uint8Array([
  0x5a, 0xaf, 0xce, 0xeb, 0x1c, 0x7a, 0xd5, 0x8e,
])
