    ...
    <div class="max-h-80 space-y-1 overflow-y-auto pr-1">
      <TransitionGroup name="list">
        ...
        >
          ...
          >
            <img
              v-if="SCROLL_CHAIN_IDS.has(entry.chainId)"
              :src="ScrollLogo"
              alt="Scroll"
            ...
            <div class="min-w-0 flex-1">
              ...
              <div
                class="flex items-center gap-2 font-mono text-[10px] text-white/30"
              >
            ...
            <div class="flex shrink-0 items-center gap-1">
              ...
              <component
                :is="expandedEntries.has(entry.id) ? ChevronUp : ChevronDown"
          ...
          <Transition name="fade">
            <div
              ...
              class="border-t border-glass-border/50 px-3 pb-2 pt-1.5"
            >
